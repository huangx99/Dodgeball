...
bool AEnemyCharacter::LookAtActor(AActor* TargetActor)
{
	...
	TArray<const AActor*> IgonreActors{ this, TargetActor };
	if (UDodgeballFunctionLibrary::CanSeeActor(GetWorld(), SightSource->GetComponentLocation(), TargetActor, IgonreActors))
	{
...
void AEnemyCharacter::ThrowDodgeball()
{
	...
	auto Proj = GetWorld()->SpawnActorDeferred<ADodgeballProjectile>(DodgeballClass, Transform, this);
	Proj->GetProjrctileMovementComponent()->InitialSpeed = 2000;
